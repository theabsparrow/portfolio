...
import { techLogo } from "@/const/techLogo";

const CoreSkills = () => {
  const [open, setOpen] = useState<boolean>(true);
  const [startSpin, setStartSpin] = useState<boolean>(true);
  const [speedSpin, setSpeedSpin] = useState<boolean>(false);
  const [mediumSpin, setMediumSpin] = useState<boolean>(false);
  return (
    <section className="space-y-6 ">
      ...
      <div className="flex justify-between">
        <div className="lg:h-150 overflow-hidden flex flex-col items-center justify-center w-full grow">
