...
const Banner = () => {
  return (
    <section className=" mt-21 space-y-1">
      <div className="relative lg:h-155 bg-[url('/my-image.webp')] bg-cover bg-center bg-no-repeat flex items-start justify-end rounded-3xl overflow-hidden shadow-xl p-4 lg:p-10">
        <div className="absolute inset-0 bg-linear-to-r from-black/20 to-black/80 z-10 " />
