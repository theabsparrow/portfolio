...
import { TBlogs } from "@/const/blog.const";
import { dateFormating } from "@/utills/dateFormating";

type TFeaturedBlogComponent = { blog: TBlogs; isLatest: boolean };

const FeaturedBlogComponent = ({ blog, isLatest }: TFeaturedBlogComponent) => {
  return (
