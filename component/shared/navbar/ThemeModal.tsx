...
import { TTheme } from "@/types/navbar.types";
import { themeIcon } from "@/const/themeIcon.const";
...
const ThemeModal = ({ enabled, setEnabled }: TThemeModalProps) => {
  ...
  useEffect(() => {
    ...
    const applyTheme = (themeValue: TTheme) => {
    ...
    applyTheme(savedTheme as TTheme);
  }, []);
