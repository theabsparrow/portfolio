      ...
      <section className="fixed inset-0 z-50 bg-[rgba(0,0,0,0.7)] dark:bg-[rgba(255,255,255,0.2)] flex justify-center items-center">
        ...
        >
          ...
          <Link
            ...
            className="bg-linear-to-r from-blue-500 to-blue-700 text-white px-4 py-2 rounded-md shadow-md hover:opacity-90 transition w-full flex items-center justify-center"
          >
            Follow on Github
          </Link>
