...
import DisplayDecoration from "./Displaydecoration";
...
import {
  ...
  thirdtPopupTitle,
} from "@/const/githubPopup.const";

const Navbar = () => {
  const [modalIndex, setModalIndex] = useState<number | null>(null);
  const [menuOpen, setMenuOpen] = useState<boolean>(false);
  const [open, setOpen] = useState<boolean>(false);
  const [darkOverlayVisible, setDarkOverlayVisible] = useState<boolean>(false);
          ...
          <div className=" flex items-center space-x-8">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div ref={containerRef}>
                ...
                <div className="absolute md:top-17 left-44 w-[38%] hidden md:flex ">
